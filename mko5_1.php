                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <form action="mko3_1db.php" method="POST">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">2.หลักสูตรและประเภทรายวิชา</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">5.ภาคการศึกษา/ชั้นปีที่่เรียนที่ฝึกประสบการณ์ภาคสนาม</label>
                                            <div class="col-sm-10">
