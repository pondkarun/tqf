                                            ...
                                            <tbody>
                                                <?php while ($row = mysqli_fetch_array($result)) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $COUNT_MKO3 = ($row['COUNT_MKO4'] > 0) ? 'ส่งแล้ว' : 'ยังไม่ส่ง'; ?></td>
                                                        <td class="text-center"><?php echo $COUNT_MKO3 = ($row['COUNT_MKO5'] > 0) ? 'ส่งแล้ว' : 'ยังไม่ส่ง'; ?></td>
                                                        <td class="text-center"><?php echo $COUNT_MKO3 = ($row['COUNT_MKO6'] > 0) ? 'ส่งแล้ว' : 'ยังไม่ส่ง'; ?></td>
