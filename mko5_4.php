                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <form action="mko5_4_save.php" method="POST">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-11">
                                                <input type="text" class="form-control" name="you" placeholder="ปัญหาในการใช้แหล่งทรัพยากรประกอบการเรียนการสอน (ถ้ามี)" ?>
                                                <input type="text" class="form-control" name="caa" placeholder="ผลกระทบ (ถ้ามี)" ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-11">
                                                <input type="text" class="form-control" name="gam" placeholder="ปัญหาในการใช้แหล่งทรัพยากรประกอบการเรียนการสอน (ถ้ามี)" ?>
                                                <input type="text" class="form-control" name="gam1" placeholder="ผลกระทบ (ถ้ามี)" ?>
                                            </div>
                                        </div>
